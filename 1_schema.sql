...
-- Création de l'utilisateur avec privilèges d'administration sur cette base
...
-- Table : foccacia (Nommée ainsi selon le MCD du brief)
...
-- Table d'association : est constitué
